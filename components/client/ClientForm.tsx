...
export function ClientForm({ mode, initial }: { mode: Mode; initial?: Client }) {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    const payload = {
      ...
      targetAudience,
      toneOfVoice,
      examplePhrases: examplePhrases.trim() || undefined,
      avoidTopics: avoidTopics.trim() || undefined,
      primaryPlatform,
      avatarColor,
      contentGoal: contentGoal || undefined,
      videoPace: videoPace || undefined,
      languageStyle: languageStyle || undefined,
      ctaStyle: ctaStyle || undefined,
      brandKeywords: brandKeywords.trim() || undefined,
      competitorNames: competitorNames.trim() || undefined,
