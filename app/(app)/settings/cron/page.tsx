      ...
      <div className="p-6 md:p-10 max-w-3xl mx-auto space-y-6">
        <div>
          ...
          <p className="text-sm text-text-secondary dark:text-dark-muted mt-1">
            Schedule automatic script generation for your clients.
          </p>
        </div>
        <Card>
    ...
    <div className="p-6 md:p-10 max-w-3xl mx-auto space-y-6">
      <div className="flex items-start justify-between gap-4">
        ...
        <Link
          ...
          className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md text-sm font-medium bg-[var(--color-primary)] text-white hover:opacity-90 transition-opacity shrink-0"
        >
          + Add schedule
        </Link>
      </div>
