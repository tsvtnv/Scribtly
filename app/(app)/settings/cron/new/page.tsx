  ...
  return (
    <div className="p-6 md:p-10 max-w-xl mx-auto space-y-6">
      ...
      <p className="text-sm text-text-secondary dark:text-dark-muted">
        Each auto-generated script uses 1 of your monthly scripts. Use <code className="bg-[var(--color-surface-raised,#f4f4f4)] dark:bg-white/10 px-1 rounded text-xs">{"{{niche}}"}</code> and{" "}
